      ...
      body: SingleChildScrollView(
        child: Stack(
          children: [
            ...
            Padding(
              padding: const EdgeInsets.only(top: 687, left: 80),
              child: SizedBox(
                height: 50,
                width: 250,
                child: TextField(controller: numbercontroller,
                  ...
                  style: TextStyle(color: Colors.black),
                  decoration: InputDecoration(
                      border: UnderlineInputBorder(),errorText: 'enter number', hintText: 'Phone number',
                      ),
                ),
              ),
            ),
            Padding(
              padding: const EdgeInsets.only(top: 732, left: 80),
              child: SizedBox(
                height: 50,
                width: 150,
                child: TextField(
